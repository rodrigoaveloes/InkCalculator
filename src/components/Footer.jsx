...
<footer class="bg-white dark:bg-gray-800 w-full py-8">
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <div class="pt-8 flex max-w-xs mx-auto items-center justify-center">
            ...
            <a href="https://github.com/rodrigoaveloes" class="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200 mx-2">
            ...
            <a href="https://www.linkedin.com/in/rodrigo-avelões-a4a560208" class="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200 mx-2">
    ...
    <div className="flex-center justify-center text-center">
        <span className="text-xs text-slate-400 font-thin font-heading text-center justify-center"> By: Rodrigo Avelões</span>
        </div>
</footer>
